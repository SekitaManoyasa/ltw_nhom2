...
namespace EcommerceStore_Nhóm2.Areas.Admin.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductID,ProductName,IsFavorite,Price,Rating,Version,Description,ImageList,CategoryID")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductID,ProductName,IsFavorite,Price,Rating,Version,Description,ImageList,CategoryID")] Product product)
        {
            if (ModelState.IsValid)
            {
